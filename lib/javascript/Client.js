...
function kb_GenomeBrowser(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.browse_genome_app = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_GenomeBrowser.browse_genome_app",
            [params], 1, _callback, _errorCallback);
    };
 
     this.build_genome_browser = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "kb_GenomeBrowser.build_genome_browser",
            [params], 1, _callback, _errorCallback);
    };
