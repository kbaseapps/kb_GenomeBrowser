...
function kb_GenomeBrowser(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.browse_genome = function (genome_ref, result_workspace_name, _callback, _errorCallback) {
        if (typeof genome_ref === 'function')
            throw 'Argument genome_ref can not be a function';
        if (typeof result_workspace_name === 'function')
            throw 'Argument result_workspace_name can not be a function';
        ...
        return json_call_ajax(_url, "kb_GenomeBrowser.browse_genome",
            [genome_ref, result_workspace_name], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_GenomeBrowser.status",
