...
function GenomeBrowser(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.browse_genome = function (genome_ref, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeBrowser.browse_genome",
            [genome_ref], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeBrowser.status",
